...
local TEXT = {
    en = {
        ...
        [4] = "Added a localized Version Updates panel beside About. It supports mouse, keyboard, and controller navigation and shows concise release summaries.",
    ...
    ["zh-hans"] = {
        ...
        [4] = "在“关于”左侧新增本地化的“版本更新”面板。支持鼠标、键盘和手柄导航，并显示简洁的版本摘要。",
    ...
    ["zh-hant"] = {
        ...
        [4] = "在「關於」左側新增本地化的「版本更新」面板。支援滑鼠、鍵盤和控制器導覽，並顯示簡潔的版本摘要。",
    ...
    ja = {
        ...
        [4] = "Aboutの隣にローカライズ済みの更新履歴パネルを追加しました。マウス、キーボード、コントローラー操作に対応し、簡潔なリリース概要を表示します。",
    ...
    ko = {
        ...
        [4] = "정보 옆에 현지화된 버전 업데이트 패널을 추가했습니다. 마우스, 키보드, 컨트롤러 탐색을 지원하고 간결한 릴리스 요약을 표시합니다.",
...
local COMPACT_120 = {
    de = {
        ...
        "Neben Über wurde ein lokalisiertes Versionsupdates-Fenster hinzugefügt. Es unterstützt Maus-, Tastatur- und Controller-Navigation und zeigt knappe Versionszusammenfassungen.",
    },
    fr = {
        ...
        "Ajout d’un panneau Mises à jour localisé à côté d’À propos. Il prend en charge la souris, le clavier et la manette et affiche des résumés concis des versions.",
    },
    it = {
        ...
        "Aggiunto un pannello Aggiornamenti localizzato accanto a Informazioni. Supporta mouse, tastiera e controller e mostra riepiloghi concisi delle versioni.",
    },
    es = {
        ...
        "Se añadió un panel Actualizaciones localizado junto a Acerca de. Admite navegación con ratón, teclado y mando y muestra resúmenes concisos de las versiones.",
    },
    ["pt-br"] = {
        ...
        "Foi adicionado um painel Atualizações localizado ao lado de Sobre. Ele aceita navegação por mouse, teclado e controle e mostra resumos concisos das versões.",
    },
    ru = {
        ...
        "Рядом с разделом «О программе» добавлена локализованная панель обновлений. Она поддерживает мышь, клавиатуру и геймпад и показывает краткие сводки выпусков.",
    },
    tr = {
        ...
        "Hakkında bölümünün yanına yerelleştirilmiş Sürüm güncellemeleri paneli eklendi. Fare, klavye ve kontrolcüyle gezinmeyi destekler ve kısa sürüm özetleri gösterir.",
    },
    pl = {
        ...
        "Dodano zlokalizowany panel Aktualizacje wersji obok Informacji. Obsługuje nawigację myszą, klawiaturą i kontrolerem oraz pokazuje zwięzłe podsumowania wydań.",
    },
    id = {
        ...
        "Panel Pembaruan versi yang dilokalkan ditambahkan di sebelah Tentang. Panel mendukung navigasi mouse, keyboard, dan controller serta menampilkan ringkasan rilis yang singkat.",
    },
    ["es-419"] = {
        ...
        "La venta automática se ejecuta antes del guardado de Quick Stack. Los objetos excluidos mediante Inventario Tab → R siempre están protegidos y las ventas usan el modo de visualización de resultados elegido.",
        "Se agregó un panel Actualizaciones localizado junto a Acerca de. Admite navegación con mouse, teclado y control y muestra resúmenes concisos de las versiones.",
    },
    th = {
        ...
        "เพิ่มแผงอัปเดตเวอร์ชันที่แปลภาษาไว้ข้างเกี่ยวกับ รองรับการนำทางด้วยเมาส์ คีย์บอร์ด และจอย พร้อมแสดงสรุปรุ่นแบบกระชับ",
    },
    vi = {
        ...
        "Đã thêm bảng Cập nhật phiên bản được bản địa hóa cạnh Giới thiệu. Bảng hỗ trợ chuột, bàn phím và tay cầm, đồng thời hiển thị tóm tắt phiên bản ngắn gọn.",
    },
}
