...
function assertQuickStackSettings(root) {
  ...
  assert.match(releaseNotes,
    /version\s*=\s*"1\.4\.1"[\s\S]*version\s*=\s*"1\.4\.0"[\s\S]*version\s*=\s*"1\.3\.1"[\s\S]*version\s*=\s*"1\.3\.0"[\s\S]*version\s*=\s*"1\.2\.0"[\s\S]*version\s*=\s*"1\.1\.0"[\s\S]*version\s*=\s*"1\.0\.0"[\s\S]*version\s*=\s*"0\.1\.0"/,
    'version updates must list Quick Stack releases newest first');
  assert.match(releaseNotes,
    /version\s*=\s*"1\.4\.1"\s*,\s*dateUtc\s*=\s*"\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}"/,
  ...
  assert.equal(versionBlocks.length, 8,
