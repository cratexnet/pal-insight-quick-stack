...
## 1.1.0 发布验收（2026-09-05）

- 维护者在本次发布任务中确认“stack 我都测过了，可以发”，接受当前包含公会箱与
  小型孵化器功能的候选版，并授权发布 1.1.0。
- 此记录代替当前候选版的待发布确认；未提供逐项日志或具体平台信息，不能推定
  多人、专服或 WinGDK 已获得代表性实机验证。下列历史测试条目保留供追溯。
